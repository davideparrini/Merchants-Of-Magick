            ...
            <div className='container-cards-BP'>
                <div className={`${index === 0 ? 'container-card1-nc-BP' : 'container-card1-BP'}`}>
                    ...
                    <div className='box-card1-BP'>
                        <Card isShowed={true} card={playerShowed.card1} smallSize={true}/>
                    </div>
                    
                </div>
                <Card isShowed={true} card={playerShowed.card2} smallSize={true}/>
                <Card isShowed={true} card={playerShowed.card3} smallSize={true}/>
            </div>
